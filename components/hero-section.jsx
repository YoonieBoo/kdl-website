    ...
    <section className="relative pt-30 pb-30 bg-gradient-to-br from-[#08162F] via-[#0F2F55] to-[#0A1B33] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-24 items-center">
          ...
          <div className="relative h-[26rem] lg:h-[28rem] flex items-center justify-center">
            {/* Dashboard illustration behind cards (no empty square) */}
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center float-1">
              <div className="relative h-72 w-72 lg:h-80 lg:w-80 rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-950/95 via-slate-900/85 to-slate-800/80 shadow-[0_32px_90px_rgba(15,23,42,0.95)] overflow-hidden">
                {/* window header */}
            ...
            <div className="relative w-full max-w-lg">
              ...
              <div className="absolute left-[-1rem] top-16 rounded-2xl bg-slate-900/90 border border-slate-600/80 backdrop-blur-2xl px-6 py-4 shadow-[0_22px_55px_rgba(0,0,0,0.8)] float-3">
                <p className="text-[13px] font-semibold text-sky-100">
                  AI Workshops
                </p>
                <p className="mt-1 text-[13px] text-sky-50/85">
                  Hands-on sessions for corporate teams.
                </p>
              </div>

              {/* Applied Learning – upper-right */}
<div className="absolute right-[-1.5rem] top-24 rounded-2xl 
bg-cyan-400/10 
...
float-4">
  ...
  <p className="text-[13px] font-semibold text-cyan-200">
    Applied Learning
  </p>

  <p className="mt-1 text-[13px] text-cyan-100/90">
    Real data, real business impact.
              ...
              {/* Transformation chip – bottom-center */}
              <div className="absolute left-10 bottom-2 rounded-2xl bg-slate-900/90 border border-slate-600/80 backdrop-blur-2xl px-6 py-3 shadow-[0_18px_45px_rgba(0,0,0,0.85)] float-3">
                <p className="text-[12px] font-medium text-sky-50">
